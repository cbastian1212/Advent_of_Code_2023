...
def main():
    ...
    galaxies_part1 = recalculate_galaxies_coordinates(galaxies, empty_rows, empty_cols, 2)
    ...
    galaxies_part2 = recalculate_galaxies_coordinates(galaxies, empty_rows, empty_cols, 1000000)
...
def recalculate_galaxies_coordinates(galaxies: list, empty_rows, empty_cols, factor) -> list:
    '''Recalculates galaxies coordinates based on empty rows and columns in the universe map and the expansion factor'''
    new_galaxies = []
    ...
    for galaxy in galaxies:
        ...
        new_galaxy = (galaxy[0] - row_offset + row_offset * factor, galaxy[1] - col_offset + col_offset * factor)
